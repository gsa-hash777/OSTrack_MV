...
def main():
    parser = argparse.ArgumentParser(description='Run multiple trackers on image sequences.')
    parser.add_argument('--tracker_name', type=str, default="ostrack", help='Name of tracking method.')
    parser.add_argument('--tracker_param', type=str, default="vitb_256_mae_32x4_ep300", help='Name of parameter file.')
    parser.add_argument('--video_paths', nargs=6, default=[

        # "D:/MultiViewDataset/wildtrack/WildTrackSeq6/camera1/img",
        # "D:/MultiViewDataset/wildtrack/WildTrackSeq6/camera2/img",
        # "D:/MultiViewDataset/wildtrack/WildTrackSeq6/camera3/img",
        # "D:/MultiViewDataset/wildtrack/WildTrackSeq6/camera5/img",
        # "D:/MultiViewDataset/wildtrack/WildTrackSeq6/camera6/img",
        # "D:/MultiViewDataset/wildtrack/WildTrackSeq6/camera7/img"

        "E:/BaiduNetdiskDownload/Two-MDOT/two_train/two/md2005/md2005-1/img",
        "E:/BaiduNetdiskDownload/Two-MDOT/two_train/two/md2005/md2005-2/img"

        # "D:/MultiViewDataset/2019GMTD1/camera1/img",
        # "D:/MultiViewDataset/2019GMTD1/camera2/img",
        # "D:/MultiViewDataset/2019GMTD1/camera3/img"


    ], help='paths to videos or image folders')
    parser.add_argument('--paths', nargs=6, default=[

        "E:/BaiduNetdiskDownload/Two-MDOT/two_train/two/md2005/md2005-1",
        "E:/BaiduNetdiskDownload/Two-MDOT/two_train/two/md2005/md2005-2"
    ...
    # 从 groundtruth 文件中读取初始框
    # optional_boxes = [read_initial_groundtruth(path) for path in args.video_paths]
    # all_gt_boxes = [read_all_groundtruth(path) for path in args.video_paths]

    optional_boxes = [read_initial_groundtruth(path) for path in args.paths]
    all_gt_boxes = [read_all_groundtruth(path) for path in args.paths]

    # 从parser中读取初始框
    # optional_boxes = [parse_bbox(bbox_str) for bbox_str in args.init_rects]

    # Run multiple trackers
    run_multiple_trackers(args.tracker_name, args.tracker_param, args.video_paths, optional_boxes, all_gt_boxes, args.debug, args.save_results)
